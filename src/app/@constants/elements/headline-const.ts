...
export const HEADLINE_CONST = {
  PREFIX: ELEMENT_ITEM.HEADLINE.toUpperCase(),
...
export const HEADLINE_DEFAULT_DATA_DEVICE = {
  option: {
    index: 1,
    sticky: !1,
...
export const HEADLINE_DEFAULT_DATA = {
  id: null,
  name: null,
  ...
  [DEVICE.DESKTOP]: copy(
    HEADLINE_DEFAULT_DATA_DEVICE,
  ) as typeof HEADLINE_DEFAULT_DATA_DEVICE,
  [DEVICE.MOBILE]: copy(
    HEADLINE_DEFAULT_DATA_DEVICE,
  ) as typeof HEADLINE_DEFAULT_DATA_DEVICE,
};
...
export const createHeadline = (
  ...
  const element = copy(HEADLINE_DEFAULT_DATA);
  element.id = `${HEADLINE_CONST.PREFIX}${index}`;
  element.name = `${HEADLINE_CONST.PREFIX}${index}`;
